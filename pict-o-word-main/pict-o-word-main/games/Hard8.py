...
class Boxes:
    def __init__(self, game):
        ...
        self.correct_positions = [
            {0: 7, 1: 9, 2: 13, 3: 8, 4: 0, 5: 12, 6: 10, 7: 6, 8: 14},  # First correct configuration
            {0: 7, 1: 9, 2: 13, 3: 8, 4: 14, 5: 12, 6: 10, 7: 6, 8: 0}# Second correct configuration
        ]
    ...
    def check_win(self):
        ...
        correct_position2 = [(442, 430), (486, 430), (530, 430), (574, 430), (794, 430), (662, 430), (706, 430), (750, 430), (618, 430)]
...
class Game:
    def __init__(self, screen):
        ...
        image_path1 = os.path.join(base_path, "hard", "Nostalgia", "a.png")
        image_path2 = os.path.join(base_path, "hard", "Nostalgia", "b.png")
        image_path3 = os.path.join(base_path, "hard", "Nostalgia", "c.png")
        image_path4 = os.path.join(base_path, "hard", "Nostalgia", "d.png")
        ...
        self.others_two = self.font.render("G", True, (0, 0, 0))
        self.others_three = self.font.render("V", True, (0, 0, 0))
        self.others_four = self.font.render("L", True, (0, 0, 0))
