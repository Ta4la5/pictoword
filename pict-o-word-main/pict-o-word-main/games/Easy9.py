...
class Boxes:
    def __init__(self, game):
        ...
        self.correct_positions = {
            0: 10,  # index of the first correct letter
...
class Game:
    def __init__(self, screen):
        ...
        image_path1 = os.path.join(base_path, "easy", "House", "a.png")
        image_path2 = os.path.join(base_path, "easy", "House", "b.png")
        image_path3 = os.path.join(base_path, "easy", "House", "c.png")
        image_path4 = os.path.join(base_path, "easy", "House", "d.png")
