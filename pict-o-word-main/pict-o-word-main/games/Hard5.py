...
class Boxes:
    def __init__(self, game):
        ...
        self.correct_positions = {
            ...
            1: 10,  # index of the second correct letter
            2: 6,  # index of the third correct letter
            3: 13,  # index of the fourth correct letter
            4: 2,  # index of the fifth correct letter
            5: 5,
            6: 12,
        }
    ...
    def check_win(self):
        print("Checking win")
        correct_positions = [(486, 430), (530, 430), (574, 430), (618, 430), (662, 430), (706, 430), (750, 430)]
...
class Game:
    def __init__(self, screen):
        ...
        image_path1 = os.path.join(base_path, "hard", "Whisper", "a.png")
        image_path2 = os.path.join(base_path, "hard", "Whisper", "b.png")
        image_path3 = os.path.join(base_path, "hard", "Whisper", "c.png")
        image_path4 = os.path.join(base_path, "hard", "Whisper", "d.png")
