...
class Boxes:
    def __init__(self, game):
        ...
        self.correct_positions = [
            {0: 1, 1: 9, 2: 7, 3: 11, 4: 0, 5: 12, 6: 8},  # First correct configuration
            {0: 11, 1: 9, 2: 7, 3: 1, 4: 0, 5: 12, 6: 8}  # Second correct configuration
        ]
...
class Game:
    def __init__(self, screen):
        ...
        image_path1 = os.path.join(base_path, "medium", "Concert", "a.png")
        image_path2 = os.path.join(base_path, "medium", "Concert", "b.png")
        image_path3 = os.path.join(base_path, "medium", "Concert", "c.png")
        image_path4 = os.path.join(base_path, "medium", "Concert", "d.png")
