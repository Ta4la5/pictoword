...
class Boxes:
    def __init__(self, game):
        ...
        self.correct_positions = [
            {0: 0, 1: 2, 2: 6, 3: 13, 4: 4, 5: 14, 6: 1, 7: 11},  # First correct configuration
            {0: 0, 1: 13, 2: 6, 3: 2, 4: 4, 5: 14, 6: 1, 7: 11}  # Second correct configuration
        ]
    ...
    def check_win(self):
        ...
        correct_position2 = [(442 + 22, 430), (574 + 22, 430), (530 + 22, 430), (486 + 22, 430), (618 + 22, 430), (662 + 22, 430), (706 + 22, 430), (750 + 22, 430)]
...
class Game:
    def __init__(self, screen):
        ...
        image_path1 = os.path.join(base_path, "hard", "Epiphany", "a.png")
        image_path2 = os.path.join(base_path, "hard", "Epiphany", "b.png")
        image_path3 = os.path.join(base_path, "hard", "Epiphany", "c.png")
        image_path4 = os.path.join(base_path, "hard", "Epiphany", "d.png")
        ...
        self.others_two = self.font.render("Z", True, (0, 0, 0))
        self.others_three = self.font.render("Y", True, (0, 0, 0))
