...
class Boxes:
    def __init__(self, game):
        ...
        self.correct_positions = [
            {0: 1, 1: 10, 2: 0, 3: 14, 4: 8, 5: 12, 6: 4},  # First correct configuration
            {0: 8, 1: 10, 2: 0, 3: 14, 4: 1, 5: 12, 6: 4},  # Second correct configuration
            {0: 1, 1: 10, 2: 4, 3: 14, 4: 8, 5: 12, 6: 0},  # Third correct configuration
            {0: 8, 1: 10, 2: 4, 3: 14, 4: 1, 5: 12, 6: 0}  # Fourth correct configuration
        ]
...
class Game:
    def __init__(self, screen):
        ...
        image_path1 = os.path.join(base_path, "medium", "Theater", "a.jpg")
        image_path2 = os.path.join(base_path, "medium", "Theater", "b.jpg")
        image_path3 = os.path.join(base_path, "medium", "Theater", "c.jpg")
        image_path4 = os.path.join(base_path, "medium", "Theater", "d.jpg")
