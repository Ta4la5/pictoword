...
class Boxes:
    def __init__(self, game):
        ...
        self.correct_positions = [
            {0: 10, 1: 14, 2: 2, 3: 4, 4: 6, 5: 7, 6: 0, 7: 1, 8: 13},  # First correct configuration
            {0: 10, 1: 14, 2: 2, 3: 4, 4: 6, 5: 7, 6: 0, 7: 13, 8: 1},  # Second correct configuration
            {0: 10, 1: 14, 2: 4, 3: 2, 4: 6, 5: 7, 6: 0, 7: 1, 8: 13},  # Third correct configuration
            {0: 10, 1: 14, 2: 4, 3: 2, 4: 6, 5: 7, 6: 0, 7: 13, 8: 1}  # Fourth correct configuration
        ]
    ...
    def check_win(self):
        ...
        correct_position2 = [(442, 430), (486, 430), (574, 430), (530, 430), (618, 430), (662, 430), (706, 430), (750, 430), (794, 430)]
        correct_position3 = [(442, 430), (486, 430), (530, 430), (574, 430), (618, 430), (662, 430), (706, 430), (794, 430), (750, 430)]
        correct_position4 = [(442, 430), (486, 430), (574, 430), (530, 430), (618, 430), (662, 430), (706, 430), (794, 430), (750, 430)]
    ...
    def display_last_chance_effect(self):
        ...
        text = font.render('Last Chance!', True, (255, 255, 0))  # Yellow text to indicate urgency
                ...
                if self.count == len(self.movement_positions):
                    if self.check_win():
                        ...
                        if self.tries_left <= 0:
                            ...
                            # Trigger last chance effect when 1 try is left
...
class Game:
    def __init__(self, screen):
        ...
        image_path1 = os.path.join(base_path, "medium", "Happiness", "a.png")
        image_path2 = os.path.join(base_path, "medium", "Happiness", "b.png")
        image_path3 = os.path.join(base_path, "medium", "Happiness", "c.png")
        image_path4 = os.path.join(base_path, "medium", "Happiness", "d.png")
