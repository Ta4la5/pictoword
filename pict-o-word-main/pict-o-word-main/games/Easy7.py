...
class Game:
    def __init__(self, screen):
        ...
        image_path1 = os.path.join(base_path, "easy", "Car", "a.png")
        image_path2 = os.path.join(base_path, "easy", "Car", "b.png")
        image_path3 = os.path.join(base_path, "easy", "Car", "c.png")
        image_path4 = os.path.join(base_path, "easy", "Car", "d.png")
    ...
    def draw_coin_counter(self):
        self.draw_rect_with_shadow(self.screen, self.PINK1, (self.screen.get_width() - 130, 20, 110, 40), border_radius=20)
