...
class Boxes:
    def __init__(self, game):
        ...
        self.correct_positions = [
            {0: 13, 1: 3, 2: 5, 3: 14, 4: 0, 5: 12},  # First correct configuration
            {0: 13, 1: 3, 2: 14, 3: 5, 4: 0, 5: 12}  # Second correct configuration
        ]
    ...
    def check_win(self):
        ...
        # Define the correct positions for two possible winning configurations as lists of tuples
        correct_position1 = [(486 + 22, 430), (530 + 22, 430), (574 + 22, 430), (618 + 22, 430), (662 + 22, 430),
                             (706 + 22, 430)]
        correct_position2 = [(486 + 22, 430), (530 + 22, 430), (618 + 22, 430), (574 + 22, 430), (662 + 22, 430),
                             (706 + 22, 430)]

        # Get current top-left positions of the boxes that should match the correct positions
        current_positions = [
        ...
        # Check if the current positions match any of the correct positions
...
class Game:
    def __init__(self, screen):
        ...
        image_path1 = os.path.join(base_path, "easy", "Summer", "a.jpg")
        image_path2 = os.path.join(base_path, "easy", "Summer", "b.jpg")
        image_path3 = os.path.join(base_path, "easy", "Summer", "c.jpg")
        image_path4 = os.path.join(base_path, "easy", "Summer", "d.jpg")
