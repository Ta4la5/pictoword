...
class Boxes:
    def __init__(self, game):
        ...
        self.answer_boxX = [574, 618, 662]
        self.answer_boxY = [430, 430, 430]
        self.answer_box = [pygame.image.load("sav.jpg") for _ in range(3)]
        ...
        self.correct_positions = {
            ...
            1: 3,  # index of the second correct letter
    ...
    def check_win(self):
        print("Checking win")
        correct_position1 = [(574, 430), (618, 430), (662, 430)]
...
class Game:
    def __init__(self, screen):
        ...
        image_path1 = os.path.join(base_path, "easy", "Sun", "a.png")
        image_path2 = os.path.join(base_path, "easy", "Sun", "b.png")
        image_path3 = os.path.join(base_path, "easy", "Sun", "c.png")
        image_path4 = os.path.join(base_path, "easy", "Sun", "d.png")
        ...
        self.ans_three = self.font.render("C", True, (0, 0, 0))
        self.ans_four = self.font.render("U", True, (0, 0, 0))
        self.ans_five = self.font.render("A", True, (0, 0, 0))
        self.ans_six = self.font.render("G", True, (0, 0, 0))
        ...
        self.others_three = self.font.render("P", True, (0, 0, 0))
        ...
        self.others_seven = self.font.render("L", True, (0, 0, 0))
