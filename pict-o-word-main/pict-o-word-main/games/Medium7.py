...
class Boxes:
    def __init__(self, game):
        ...
        self.answer_boxX = [486, 530, 574, 618, 662, 706, 750]
        self.answer_boxY = [430, 430, 430, 430, 430, 430, 430]
        self.answer_box = [pygame.image.load("sav.jpg") for _ in range(7)]
        ...
        self.correct_positions = {
            0: 0,  # index of the first correct letter
            1: 9,  # index of the second correct letter
            2: 3,  # index of the third correct letter
            3: 12,  # index of the fourth correct letter
            4: 7,  # index of the fifth correct letter
            5: 4,
            6: 13
        }
...
class Game:
    def __init__(self, screen):
        ...
        image_path1 = os.path.join(base_path, "medium", "Journey", "a.png")
        image_path2 = os.path.join(base_path, "medium", "Journey", "b.png")
        image_path3 = os.path.join(base_path, "medium", "Journey", "c.png")
        image_path4 = os.path.join(base_path, "medium", "Journey", "d.png")
        ...
        self.others_five = self.font.render("Y", True, (0, 0, 0))
