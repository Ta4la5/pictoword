...
class Boxes:
    def __init__(self, game):
        ...
        self.answer_boxX = [398+22, 442+22, 486+22, 530+22, 574+22, 618+22, 662+22, 706+22, 750+22, 794+22]
        self.answer_boxY = [430, 430, 430, 430, 430, 430, 430, 430, 430, 430]
        self.answer_box = [pygame.image.load("sav.jpg") for _ in range(10)]
        ...
        self.correct_positions = [
            {0: 12, 1: 0, 2: 11, 3: 6, 4: 4, 5: 9, 6: 10, 7: 1, 8: 15, 9: 7},
            {0: 12, 1: 7, 2: 11, 3: 6, 4: 4, 5: 9, 6: 10, 7: 1, 8: 15, 9: 0},
            {0: 12, 1: 10, 2: 11, 3: 6, 4: 4, 5: 9, 6: 7, 7: 1, 8: 15, 9: 0},
            {0: 12, 1: 0, 2: 11, 3: 9, 4: 4, 5: 6, 6: 10, 7: 1, 8: 15, 9: 7},
            {0: 12, 1: 7, 2: 11, 3: 9, 4: 4, 5: 6, 6: 10, 7: 1, 8: 15, 9: 0},
            {0: 12, 1: 10, 2: 11, 3: 9, 4: 4, 5: 6, 6: 7, 7: 1, 8: 15, 9: 0},
            {0: 12, 1: 0, 2: 11, 3: 9, 4: 4, 5: 6, 6: 7, 7: 1, 8: 15, 9: 10},
            {0: 12, 1: 7, 2: 11, 3: 9, 4: 4, 5: 6, 6: 0, 7: 1, 8: 15, 9: 10},
            {0: 12, 1: 10, 2: 11, 3: 9, 4: 4, 5: 6, 6: 0, 7: 1, 8: 15, 9: 7},
            {0: 12, 1: 0, 2: 11, 3: 6, 4: 4, 5: 9, 6: 7, 7: 1, 8: 15, 9: 10},
            {0: 12, 1: 7, 2: 11, 3: 6, 4: 4, 5: 9, 6: 0, 7: 1, 8: 15, 9: 10},
            {0: 12, 1: 10, 2: 11, 3: 6, 4: 4, 5: 9, 6: 0, 7: 1, 8: 15, 9: 7}
        ]
    ...
    def check_win(self):
        print("Checking win")
        correct_position1 = [(398 + 22, 430), (442 + 22, 430), (486 + 22, 430), (530 + 22, 430), (574 + 22, 430), (
        618 + 22, 430), (662 + 22, 430), (706 + 22, 430), (750 + 22, 430), (794 + 22, 430)]
        correct_position2 = [(398 + 22, 430), (442 + 22, 430), (486 + 22, 430), (530 + 22, 430), (574 + 22, 430), (
        618 + 22, 430), (794 + 22, 430), (706 + 22, 430), (750 + 22, 430), (662 + 22, 430)]
        correct_position3 = [(398 + 22, 430), (662 + 22, 430), (486 + 22, 430), (530 + 22, 430), (574 + 22, 430), (
        618 + 22, 430), (442 + 22, 430), (706 + 22, 430), (750 + 22, 430), (794 + 22, 430)]
        correct_position4 = [(398 + 22, 430), (662 + 22, 430), (486 + 22, 430), (530 + 22, 430), (574 + 22, 430), (
        618 + 22, 430), (794 + 22, 430), (706 + 22, 430), (750 + 22, 430), (442 + 22, 430)]
        correct_position5 = [(398 + 22, 430), (794 + 22, 430), (486 + 22, 430), (530 + 22, 430), (574 + 22, 430), (
        618 + 22, 430), (442 + 22, 430), (706 + 22, 430), (750 + 22, 430), (662 + 22, 430)]
        correct_position6 = [(398 + 22, 430), (794 + 22, 430), (486 + 22, 430), (530 + 22, 430), (574 + 22, 430), (
        618 + 22, 430), (662 + 22, 430), (706 + 22, 430), (750 + 22, 430), (442 + 22, 430)]
        correct_position7 = [(398 + 22, 430), (442 + 22, 430), (486 + 22, 430), (618 + 22, 430), (574 + 22, 430), (
        530 + 22, 430), (662 + 22, 430), (706 + 22, 430), (750 + 22, 430), (794 + 22, 430)]
        correct_position8 = [(398 + 22, 430), (442 + 22, 430), (486 + 22, 430), (618 + 22, 430), (574 + 22, 430), (
        530 + 22, 430), (794 + 22, 430), (706 + 22, 430), (750 + 22, 430), (662 + 22, 430)]
        correct_position9 = [(398 + 22, 430), (662 + 22, 430), (486 + 22, 430), (618 + 22, 430), (574 + 22, 430), (
        530 + 22, 430), (442 + 22, 430), (706 + 22, 430), (750 + 22, 430), (794 + 22, 430)]
        correct_position10 = [(398 + 22, 430), (662 + 22, 430), (486 + 22, 430), (618 + 22, 430), (574 + 22, 430), (
        530 + 22, 430), (794 + 22, 430), (706 + 22, 430), (750 + 22, 430), (442 + 22, 430)]
        correct_position11 = [(398 + 22, 430), (794 + 22, 430), (486 + 22, 430), (618 + 22, 430), (574 + 22, 430), (
        530 + 22, 430), (442 + 22, 430), (706 + 22, 430), (750 + 22, 430), (662 + 22, 430)]
        correct_position12 = [(398 + 22, 430), (794 + 22, 430), (486 + 22, 430), (618 + 22, 430), (574 + 22, 430), (
        530 + 22, 430), (662 + 22, 430), (706 + 22, 430), (750 + 22, 430), (442 + 22, 430)]
        ...
        current_positions = [
            ...
            self.box_rects[self.correct_positions[0][9]].topleft,
        ]
...
class Game:
    def __init__(self, screen):
        ...
        image_path1 = os.path.join(base_path, "hard", "Resilience", "a.png")
        image_path2 = os.path.join(base_path, "hard", "Resilience", "b.png")
        image_path3 = os.path.join(base_path, "hard", "Resilience", "c.png")
        image_path4 = os.path.join(base_path, "hard", "Resilience", "d.png")
        ...
        self.ans_eight = self.font.render("E", True, (0, 0, 0))
        self.ans_nine = self.font.render("T", True, (0, 0, 0))

        self.others_one = self.font.render("I", True, (0, 0, 0))
        self.others_two = self.font.render("E", True, (0, 0, 0))
        self.others_three = self.font.render("S", True, (0, 0, 0))
        ...
        self.others_seven = self.font.render("C", True, (0, 0, 0))
