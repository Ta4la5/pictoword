...
class Boxes:
    def __init__(self, game):
        ...
        self.correct_positions = {
            ...
            1: 12,  # index of the second correct letter
            2: 9,  # index of the third correct letter
            3: 11,  # index of the fourth correct letter
            4: 6,  # index of the fifth correct letter
            5: 1,
            6: 15,
            7: 0,
        }
    ...
    def check_win(self):
        print("Checking win")
        correct_positions = [(442+22, 430), (486+22, 430), (530+22, 430), (574+22, 430), (618+22, 430), (662+22, 430), (706+22, 430), (750+22, 430)]
...
class Game:
    def __init__(self, screen):
        ...
        image_path1 = os.path.join(base_path, "hard", "Province", "a.png")
        image_path2 = os.path.join(base_path, "hard", "Province", "b.png")
        image_path3 = os.path.join(base_path, "hard", "Province", "c.png")
        image_path4 = os.path.join(base_path, "hard", "Province", "d.png")
