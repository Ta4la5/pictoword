...
class Boxes:
    def __init__(self, game):
        ...
        self.correct_positions = [
            {0: 2, 1: 0, 2: 9, 3: 5, 4: 4},  # First correct configuration
            {0: 2, 1: 4, 2: 9, 3: 5, 4: 0},  # Second correct configuration
        ]
...
class Game:
    def __init__(self, screen):
        ...
        image_path1 = os.path.join(base_path, "medium", "Peace", "a.png")
        image_path2 = os.path.join(base_path, "medium", "Peace", "b.png")
        image_path3 = os.path.join(base_path, "medium", "Peace", "c.png")
        image_path4 = os.path.join(base_path, "medium", "Peace", "d.png")
        ...
        self.ans_six = self.font.render("C", True, (0, 0, 0))
