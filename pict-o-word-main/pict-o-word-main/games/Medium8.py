...
class Boxes:
    def __init__(self, game):
        ...
        self.correct_positions = {
            0: 1,  # index of the first correct letter
            1: 14,  # index of the second correct letter
            2: 7,  # index of the third correct letter
            3: 0,  # index of the fourth correct letter
        }
...
class Game:
    def __init__(self, screen):
        ...
        image_path1 = os.path.join(base_path, "medium", "Love", "a.png")
        image_path2 = os.path.join(base_path, "medium", "Love", "b.png")
        image_path3 = os.path.join(base_path, "medium", "Love", "c.png")
        image_path4 = os.path.join(base_path, "medium", "Love", "d.png")
        ...
        self.ans_eight = self.font.render("V", True, (0, 0, 0))
        ...
        self.others_six = self.font.render("O", True, (0, 0, 0))
