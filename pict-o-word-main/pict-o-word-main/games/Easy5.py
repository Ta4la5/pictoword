...
class Boxes:
    def __init__(self, game):
        ...
        self.correct_positions = {
            0: 8,  # index of the first correct letter
            1: 12,  # index of the second correct letter
            2: 15,  # index of the third correct letter
            3: 11,  # index of the fourth correct letter
            4: 0,  # index of the fifth correct letter
            5: 1, # index of the sixth correct letter
        }
...
class Game:
    def __init__(self, screen):
        ...
        image_path1 = os.path.join(base_path, "easy", "Travel", "a.png")
        image_path2 = os.path.join(base_path, "easy", "Travel", "b.png")
        image_path3 = os.path.join(base_path, "easy", "Travel", "c.png")
        image_path4 = os.path.join(base_path, "easy", "Travel", "d.png")
        ...
        self.others_seven = self.font.render("A", True, (0, 0, 0))
