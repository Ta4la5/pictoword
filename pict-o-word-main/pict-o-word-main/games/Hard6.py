...
class Boxes:
    def __init__(self, game):
        ...
        self.correct_positions = [
            {0: 14, 1: 5, 2: 15, 3: 2, 4: 1, 5: 3, 6: 6, 7: 8, 8: 11},  # First correct configuration
            {0: 14, 1: 5, 2: 15, 3: 6, 4: 1, 5: 3, 6: 2, 7: 8, 8: 11}  # Second correct configuration
        ]
    ...
    def check_win(self):
        ...
        correct_position2 = [(442, 430), (486, 430), (530, 430), (706, 430), (618, 430), (662, 430), (574, 430), (750, 430), (794, 430)]
...
class Game:
    def __init__(self, screen):
        ...
        image_path1 = os.path.join(base_path, "hard", "Ambiguity", "a.png")
        image_path2 = os.path.join(base_path, "hard", "Ambiguity", "b.png")
        image_path3 = os.path.join(base_path, "hard", "Ambiguity", "c.png")
        image_path4 = os.path.join(base_path, "hard", "Ambiguity", "d.png")
        ...
        self.ans_three = self.font.render("I", True, (0, 0, 0))
