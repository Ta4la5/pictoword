...
class Boxes:
    def __init__(self, game):
        ...
        self.correct_positions = {
            0: 11,  # index of the first correct letter
            1: 6,  # index of the second correct letter
            2: 13,  # index of the third correct letter
            3: 14,  # index of the fourth correct letter
            4: 1,
            5: 5,
        }
    ...
    def play_not_enough_coins_effects(self):
        ...
        not_enough_coins_sound.set_volume(0.5)  # Set click sound volume to 50%
    ...
    def reveal_letter(self):
        if self.count < len(self.movement_positions):
            correct_box_index = self.correct_positions[self.count]  # Get the correct index directly
    ...
    def check_win(self):
        print("Checking win")
        correct_position1 = [(486+22, 430), (530+22, 430), (574+22, 430), (618+22, 430), (662+22, 430), (706+22, 430)]
...
class Game:
    def __init__(self, screen):
        ...
        image_path1 = os.path.join(base_path, "medium", "Wisdom", "a.png")
        image_path2 = os.path.join(base_path, "medium", "Wisdom", "b.png")
        image_path3 = os.path.join(base_path, "medium", "Wisdom", "c.png")
        image_path4 = os.path.join(base_path, "medium", "Wisdom", "d.png")
        ...
        self.ans_two = self.font.render("O", True, (0, 0, 0))
        self.ans_three = self.font.render("P", True, (0, 0, 0))
        self.ans_four = self.font.render("T", True, (0, 0, 0))
        ...
        self.others_three = self.font.render("W", True, (0, 0, 0))
        self.others_four = self.font.render("R", True, (0, 0, 0))
        self.others_five = self.font.render("S", True, (0, 0, 0))
        self.others_six = self.font.render("D", True, (0, 0, 0))
