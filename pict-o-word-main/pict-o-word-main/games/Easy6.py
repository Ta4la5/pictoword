...
class Boxes:
    def __init__(self, game):
        ...
        self.correct_positions = [
            {0: 4, 1: 2, 2: 11, 3: 15, 4: 0},
            {0: 4, 1: 11, 2: 2, 3: 15, 4: 0}
        ]
    ...
    def check_win(self):
        ...
        correct_position2 = [(530, 430), (618, 430), (574, 430), (662, 430), (706, 430)]
...
class Game:
    def __init__(self, screen):
        ...
        image_path1 = os.path.join(base_path, "easy", "Apple", "a.png")
        image_path2 = os.path.join(base_path, "easy", "Apple", "b.png")
        image_path3 = os.path.join(base_path, "easy", "Apple", "c.png")
        image_path4 = os.path.join(base_path, "easy", "Apple", "d.png")
